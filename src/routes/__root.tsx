...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Field scanner PWA: point your phone at a cable barcode or QR label and instantly see its FNT Command cable data, with continuous scanning." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Cable Scanner — Scan cable barcodes for FNT Command data" },
      { property: "og:description", content: "Field scanner PWA: point your phone at a cable barcode or QR label and instantly see its FNT Command cable data, with continuous scanning." },
